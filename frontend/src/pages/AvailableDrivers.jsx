...
//         const response = await axios.get(`${server}/api/driver`, {
//           params: {
...
//     // This is a simplified calculation - in a real app you might use a routing service
//     // Assuming average speed of 30 km/h
//     const averageSpeedKmPerHour = 30;

//     // Basic distance calculation (this is very simplified)
//     // In a real application, you would use a routing service or distance matrix API
//     const distanceInKm = 5; // Placeholder value
...
//               <div className="flex items-center mb-4">
//                 <img
//                   src={driver.profileImage || "/images/default-driver.png"}
