...
//     "Fun Fact: In ancient Rome, chariots were the taxi service of the day!",
...
//       console.log("Driver side par ye rah data");
//       console.log(data);
...
//           </h2>
//           <p className="text-gray-600">{randomFact}</p>
//         </div>
//       )}
//       {status === "accepted" && (
//         <div className="bg-white p-8 rounded-lg shadow-lg text-center">
...
//           {driverDetails && (
//             <div className="mb-4">
//               <p className="text-lg">Driver: {driverDetails._id.name}</p>
//               <p className="text-lg">Vehicle: {driverDetails.vehicleMake}</p>
//               <p className="text-lg">Contact: {driverDetails.phoneNumber}</p>
//             </div>
//           )}
//           <div className="mb-4">
//             <p className="text-xl font-semibold">Your OTP:</p>
//             <p className="text-3xl font-bold text-blue-500">{otp}</p>
//           </div>
//           <button
//             onClick={() =>
...
//             Sorry, the driver rejected your ride request.
//           </p>
//           <button
